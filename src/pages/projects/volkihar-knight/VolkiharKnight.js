import dumplingBackgroundLarge from 'assets/dumpling-totoro-large.png';
import dumplingBackgroundPlaceholder from 'assets/volkihar-background-placeholder.jpg';
import dumplingBackground from 'assets/dumpling-totoro.png';
import dumplingBannerLarge from 'assets/dumpling-banner.jpg';
import dumplingBannerPlaceholder from 'assets/volkihar-banner-placeholder.jpg';
import dumplingBanner from 'assets/dumpling-banner.jpg';
...
const title = 'Dumpling Diaries';
const description =
  "Introducing Dumpling, a charming character created with inspiration from a special someone. Through a captivating series of illustrations, Dumpling's endearing qualities and adventures come to life. Experience the heartfelt connection as Dumpling resembles the essence of your crush, capturing both their beauty and captivating spirit in this delightful artistic journey.";
const roles = ['Digital painting', 'Texturing', 'Graphic Design'];
...
export function VolkiharKnight() {
  return (
    <Fragment>
      ...
      <ProjectContainer>
        <ProjectBackground
          srcSet={[dumplingBackground, dumplingBackgroundLarge]}
          placeholder={dumplingBackgroundPlaceholder}
          opacity={0.5}
        />
        <ProjectHeader
          title={title}
          description={description}
          linkLabel="Get the illustration"
          url="#"
          roles={roles}
        />
        ...
        <ProjectSection>
          <ProjectSectionContent>
            <ProjectImage
              srcSet={[dumplingBanner, dumplingBannerLarge]}
              placeholder={dumplingBannerPlaceholder}
              alt="A cutiepotatoe Dumpling standing at the bus stop with Totoro"
